...
class CogniStay extends Component {
    render() {
            ...
            <div className="CogniStay">
                <Router>
                    ...
                    <Routes>
                        ...
                        <Route path="/admin-Home/:id" element={<AdminAuthenticatedRoute><AdminHomePageComponentWithParams /></AdminAuthenticatedRoute>} />
...
{
    return(
        <div class="p-3 mb-2 text-danger"><center> An unexpected error has occured, please contact support at <b>INTADM22JF020POD1@support.com</b> </center></div>
    )
}

export default CogniStay;